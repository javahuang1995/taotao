 ...
 */
function login() {
    return location.href = "http://sso.taotao.com:8084/page/login";
}
function regist() {
    return location.href = "http://sso.taotao.com:8084/page/register";
}
...
function search(a) {
    var b = "http://www.taotao.com:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
